    ...
    public static class Config
    {
        ...
        public static IEnumerable<IdentityResource> IdentityResources =>
                   new IdentityResource[]
                   {
                        ...
                        new IdentityResources.OpenId(), //zorunlu, JWT'nin subid'si
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                new Client
                {
                    ...
                    ClientSecrets = {new Secret("secret".Sha256())}, // Memory'de tutulacak.
                ...
                new Client
                {
                    ...
                    AccessTokenLifetime = 1*60*60, // Token ömrü
                    RefreshTokenExpiration = TokenExpiration.Absolute, // Refresh Token ömrü her seferinde artsın mı
                    AbsoluteRefreshTokenLifetime = (int)(DateTime.Now.AddDays(60) - DateTime.Now).TotalSeconds, // Refresh Token Ömrü
                    RefreshTokenUsage = TokenUsage.ReUse // Refresh Token tekrar kullanılabilir mi
                }
            };
    }
}