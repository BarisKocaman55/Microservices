...
namespace FreeCourse.Services.Discount
{
    public class Startup
    {
        ...
        {
            var requiereAuthorizePolicyRead = new AuthorizationPolicyBuilder().RequireClaim("scope", "discount_read");
            ...
            {
                options.Filters.Add(new AuthorizeFilter(requiereAuthorizePolicy));
            });
